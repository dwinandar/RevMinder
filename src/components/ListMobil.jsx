...
function ListMotor() {
  ...
  useEffect(() => {
    ...
    //Get mobil data
    axios
      .get("http://localhost:5050/vehicle/read/mobil/" + id)
      .then((res) => {
        setMobil(res.data[0]);
      })
      .catch((err) => console.log(err));
    //
    //Get riwayat service mobil
    axios
      .get(`http://localhost:5050/service/mobil/${id}/riwayatservice`)
      .then((res) => {
        setRiwayat(res.data);
      })
      .catch((err) => console.log(err));
    ...
    //Get pengingat mobil
    axios
      .get(`http://localhost:5050/service/mobil/${id}/pengingat`)
      .then((res) => {
            ...
            <div className="lg:h-[15rem] flex flex-col  space-y-4 mt-9">
              <div className="bg-gray-200 shadow-md rounded-lg sm:w-96 p-6 ">
                ...
                <div className="flex flex-col mb-4">
                  ...
                  <input type="text" className="text-gray-400 rounded-lg ring-0 border-none focus:ring-0" value={mobil.no_pol} disabled />
                </div>
                ...
                <div className="flex flex-col mb-4">
                  ...
                  <input type="text" className="text-gray-400 rounded-lg ring-0 border-none focus:ring-0" value={mobil.jenis} disabled />
                </div>
                {/* Transmisi */}

                <div className="flex flex-col mb-4">
                  <p className="font-bold mr-2">Transmisi</p>
                  <input type="text" className="text-gray-400 rounded-lg ring-0 border-none focus:ring-0" value={mobil.transmisi} disabled />
                </div>
                {/* Tahun */}
                <div className="flex flex-col mb-4">
                  <p className="font-bold mr-2">Tahun</p>
                  <input type="text" className="text-gray-400 rounded-lg ring-0 border-none focus:ring-0" value={mobil.tahun} disabled />
                </div>
                {/* Warna */}

                <div className="flex flex-col mb-4">
                  <p className="font-bold mr-2">Warna</p>
                  <input type="text" className="text-gray-400 rounded-lg ring-0 border-none focus:ring-0" value={mobil.warna} disabled />
                </div>
              </div>
                ...
                <div className="modal-box bg-white rounded-lg shadow-lg">
                  ...
                  <div className="dialog-content flex flex-col items-center justify-center gap-6 mb-6">
                    ...
                    <div className="flex justify-center gap-2">
                      <Link to={`/dashboard/aset/mobil/${id}/tambahservice`} className="flex flex-col items-center justify-center gap-2 mx-4">
                        <RxCounterClockwiseClock size={"30"} color={"#21217A"} className="hover:scale-110" />
                        <p className="text-sm">Catat Service </p>
                      </Link>

                      <Link to={`/dashboard/aset/mobil/${id}/tambahpengingat`} className="flex flex-col items-center justify-center gap-1 mx-4">
