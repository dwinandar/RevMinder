...
const Navbar = ({ page }) => {
  ...
  return (
    <header
      className={`flex md:justify-between justify-center items-center md:px-20 px-7 w-full gap-2 transition-all text-white sticky top-0 z-30  ${page === "artikel" ? "bg-[#000]" : bgNav} py-3 duration-200`}
    >
