      ...
      <div className='flex flex-col flex-1'>
        <div className='w-auto pengaturan-container'>
          <div className='flex flex-row justify-start gap-2 px-6 py-4 '>
            ...
            >
              <span
                className={`block text-lg ${setting === "profil"
            ...
            >
              <span
                className={`block text-lg ${setting === "sandi"
                  ? "border-b-4 border-[#4C4DDC] transition"
                  : "border-trasparent"
                  }`}
              >
          ...
          <div
            className={`${setting === "profil" ? "static" : "hidden"
              } pengaturan-content xl:w-[70%] h-[28rem] mx-6 bg-[#D9D9D9] rounded-lg`}
          >
            <UbahProfil />
          </div>

          <div
            className={`${setting === "sandi" ? "static" : "hidden"
              } pengaturan-content xl:w-[70%] h-[28rem] mx-6 bg-[#D9D9D9] rounded-lg`}
          >
            <UbahSandi />
          </div>
